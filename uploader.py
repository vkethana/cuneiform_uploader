# Modified version of simple commons uploader
# This code is repurposed from this GitHub repository: https://github.com/fastily/simple-commons-uploader
# GPL v3 License
import argparse
import getpass
import logging
...
def _main() -> None:
    ...
    for base_dir in args.dirs:
        ...
        for f in base_dir.iterdir():
            ...
            # base_desc, category
            pure_filename = (os.path.split(f)[-1])
            b = os.path.splitext(pure_filename)[0]
            cat = "Cuneiform"
            cat2 = "Old Assyrian signs"
            ...
            |source=https://github.com/vkethana/cuneiform_convert
            |author=Edward Stratford; converted to SVG by Vijay Kethanaboyina
            }}}}
            ...
            if not wiki.upload(f, pure_filename, desc):
                fails.append(f)
            #print(f, pure_filename)
            #print("DESC", desc)
            i += 1
